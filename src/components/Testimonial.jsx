...
const Testimonial = () => {
  return (
    ...
    <div className='text-center mb-12'>
            ...
            <p className='text-lg mb-12 md:w-1/2 mx-auto'>Here from some of our satisfied clients about how our services have positively impacted their lives and well-being 
            </p>
          </div>
