    ...
    <div className='bg-[#f7f8fc] pt-32' id='pricing'>
        <div className='container mx-auto px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg mb-12 md:2/3 mx-auto'>The platform provides scalable, tailored solutions for businesses of all sizes, enhancing brand presence, customer engagement, and growth with flexible, budget-friendly options.
            </p>
          </div>
